      ...
      return (
          <div className="flex flex-col items-center justify-center min-h-[50vh] text-center space-y-6 animate-fadeIn">
              ...
              <button 
                ...
                className="bg-slate-800 text-white px-8 py-3 rounded-2xl font-bold hover:bg-black transition-colors"
              >
                  Enviar otro reporte
              </button>
          </div>
    ...
    <div className="max-w-3xl mx-auto space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
              <div className="bg-white p-6 rounded-[2rem] shadow-card border border-slate-50">
              ...
              <div className="bg-blue-50 p-6 rounded-[2rem] border border-blue-100">
                  ...
                  <a href="#/resources" className="block w-full py-3 bg-white text-blue-600 font-bold text-center rounded-xl hover:shadow-md transition-all text-xs uppercase tracking-wide">
                      Ir a Recursos
                  </a>
              </div>
          </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                          ...
                          <textarea 
                            ...
                            required
                            rows={6}
                            className="w-full p-4 bg-slate-50 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-indigo-200 outline-none text-slate-700 font-medium resize-none"
                      ...
                      <button 
                        ...
                        className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-2xl shadow-glow transition-all disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2"
                      >

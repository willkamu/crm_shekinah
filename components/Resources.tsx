...
const Resources: React.FC = () => {
    ...
    return (
        <div className="space-y-8 animate-fadeIn max-w-4xl mx-auto">
            ...
            <div className="flex border-b border-slate-200 overflow-x-auto no-scrollbar">
                {[
                    ...
                    <button
                        ...
                        className={`px-6 py-4 text-sm font-bold border-b-2 transition-colors whitespace-nowrap cursor-pointer ${activeTab === tab.id ? 'border-blue-500 text-blue-600' : 'border-transparent text-slate-400 hover:text-slate-600'}`}
                    >
                        {tab.label}
                    </button>
                ))}
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-xl border border-slate-50 min-h-[50vh]">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="bg-slate-50 border border-slate-200 rounded-xl pl-9 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-48 transition-all"
                                />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {filteredGlossary.map((item, i) => (
                                <div key={i} className="p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-200 transition-colors">
                                    <h4 className="font-bold text-blue-700 text-sm uppercase mb-2">{item.term}</h4>
                    ...
                    <div className="space-y-8 animate-fadeIn">
                        <div>
                            <h3 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                                <User className="w-5 h-5 text-blue-600" /> Tareas del Líder de Anexo
                            </h3>
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                                <BookOpen className="w-5 h-5 text-blue-600" /> Tareas del Maestro de Casa
                            </h3>
                            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 space-y-4 text-sm text-slate-600">

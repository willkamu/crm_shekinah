    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h2 className="text-4xl font-extrabold text-slate-900 tracking-tight mb-2">Intercesión</h2>
                    <p className="text-lg text-slate-500 font-medium">Motor Espiritual de la Iglesia</p>
                </div>
            </div>
            ...
            <div className="flex border-b border-slate-200 overflow-x-auto no-scrollbar">
                {[
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-6 py-4 text-sm font-bold border-b-2 transition-all whitespace-nowrap cursor-pointer ${activeTab === tab.id ? 'border-blue-600 text-blue-800' : 'border-transparent text-slate-400 hover:text-slate-600 hover:bg-slate-50'}`}
                    >
                ...
                <div className="space-y-6">
                    {isGlobalAdmin && (
                        <div className="flex justify-end">
                            <button
                                ...
                                className="bg-red-600 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-glow hover:bg-red-700 transition-colors flex items-center gap-2 cursor-pointer"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {intercesionGroups.map(group => {
                            ...
                            return (
                                <div key={group.id} className="bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl transition-all overflow-hidden flex flex-col h-full relative group/card">
                                    {/* ACTIONS ALWAYS VISIBLE IF PERMISSION */}
                                    {isGlobalAdmin && (
                                        <div className="absolute top-4 right-4 flex gap-1 z-10">
                                            <button
                                                onClick={() => handleOpenEditGroup(group)}
                                                className="p-2 bg-slate-50 rounded-full text-slate-500 hover:text-brand-blue hover:bg-white shadow-sm border border-slate-100 transition-all cursor-pointer"
                                                title="Editar Grupo"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="p-2 bg-slate-50 rounded-full text-slate-500 hover:text-red-500 hover:bg-white shadow-sm border border-slate-100 transition-all cursor-pointer"
                                    ...
                                    <div className="flex-1 bg-white p-4">
                                        ...
                                        {hasPermission && (
                                            <button
                                                ...
                                                className="w-full py-2 bg-red-50 text-red-600 text-xs font-bold rounded-xl hover:bg-red-100 transition-colors flex items-center justify-center gap-1 cursor-pointer"
                                            >
                    ...
                    <div className="flex flex-col md:flex-row gap-6 mb-8 border-b border-slate-100 pb-8">
                        <div className="flex-1">
                            ...
                            <select
                                ...
                                className="w-full p-4 bg-slate-50 rounded-2xl border border-slate-100 font-bold text-slate-700 outline-none focus:ring-2 focus:ring-blue-200"
                            >
                ...
                <div className="space-y-4">
                    <div className="flex justify-end mb-4">
                        <button
                            ...
                            className="flex items-center gap-2 bg-slate-800 text-white px-4 py-2 rounded-xl text-xs font-bold hover:bg-black transition-colors cursor-pointer"
                        >
            ...
            {isAssignOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 animate-fadeIn">
                    <div className="bg-white w-full max-w-md rounded-[2rem] shadow-2xl p-8 relative h-[80vh] flex flex-col border border-white/50">
                        <button onClick={() => setIsAssignOpen(false)} className="absolute top-6 right-6 p-2 bg-slate-50 rounded-full hover:bg-slate-100 text-slate-400 cursor-pointer"><X className="w-5 h-5" /></button>
                        ...
                        <div className="pt-4 border-t border-slate-100">
                            <button
                                ...
                                className="w-full py-3 bg-slate-900 text-white rounded-2xl font-bold hover:bg-black transition-colors disabled:opacity-50 shadow-glow flex justify-center items-center gap-2 cursor-pointer"
                            >
            ...
            {isGroupModalOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 animate-fadeIn">
                    <div className="bg-white w-full max-w-sm rounded-[2rem] shadow-2xl p-8 relative border border-white/50">
                        <button onClick={() => setIsGroupModalOpen(false)} className="absolute top-6 right-6 p-2 bg-slate-50 rounded-full hover:bg-slate-100 text-slate-400 cursor-pointer"><X className="w-5 h-5" /></button>
                        ...
                        <form onSubmit={handleSaveGroup} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 bg-slate-50 rounded-xl border border-slate-200 font-bold text-slate-700 outline-none focus:ring-2 focus:ring-blue-200"
                                    autoFocus
                                />
                            </div>
                            <div>
                            ...
                            <button type="submit" className="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold shadow-glow mt-2 hover:bg-black transition-colors cursor-pointer">

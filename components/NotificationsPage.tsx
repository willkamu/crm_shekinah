  ...
  return (
    <div className="space-y-6 animate-fadeIn max-w-3xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        <Link to="/" className="p-3 bg-white rounded-xl shadow-sm border border-slate-100 text-slate-400 hover:text-slate-600 transition-colors">
        ...
        <button 
            ...
            className="text-xs font-bold text-brand-blue bg-brand-soft px-4 py-2 rounded-lg hover:bg-blue-100 transition-colors"
        >
            Marcar todo leído
        </button>
      </div>

      <div className="bg-white rounded-[2.5rem] shadow-card border border-slate-50 overflow-hidden min-h-[60vh]">
